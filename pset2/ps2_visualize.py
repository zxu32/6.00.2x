...
class RobotVisualization:
    def __init__(self, num_robots, width, height, delay=0.2):
        ...
        self.robots = None
        self.text = self.w.create_text(25, 0, anchor=tkinter.NW, text=self._status_string(0, 0))
        self.time = 0
        self.master.update()
    ...
    def update(self, room, robots):
        ...
        self.text = self.w.create_text(
            25, 0, anchor=tkinter.NW, text=self._status_string(self.time, room.getNumCleanedTiles()))
        self.master.update()
